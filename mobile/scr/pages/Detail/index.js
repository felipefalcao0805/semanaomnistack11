...
export default function Detail(){
    ...
    const message = `Olá ${incident.name}, estou entrando encontato pois gostaria de ajudar no caso "${incident.titulo}" com o valor de  R$ ${Intl.NumberFormat('pt-BR', {style:'currency', currency:'BRL' }).format(incident.value)}.`;
